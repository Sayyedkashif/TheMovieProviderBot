...
MSG_ALRT = environ.get('MSG_ALRT', 'ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : Kashif Ali')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002174795565')).split()]
...
SESSION_NAME = str(environ.get('SESSION_NAME', 'Sukuna'))
MULTI_CLIENT = False
